...
> 公司节日福利发放系统 · v0.3 · 2026-05

**开发者**：Zhang Zhiyao · © 2026 All rights reserved
**项目仓库**：[github.com/zzybluebell/meet-gift](https://github.com/zzybluebell/meet-gift)
**用户设计流程图**：[docs/user-workflow.pdf](https://github.com/zzybluebell/meet-gift/blob/master/docs/user-workflow.pdf)

---

## 这套系统是干什么的？

「礼达」帮公司给员工发节日福利。把过去"HR 用 Excel 发表单、微信群催领、纸质名单核对"的麻烦做法，换成一套统一的线上流程：

- **HR** 在电脑上配置活动、发礼物、看进度
- **员工** 在手机上收通知、预约、拿核销码
- **楼层前台** 在手机上扫员工的码、把礼物递出去
...
- **v0.3**（2026-05）—— 消息推送、推送中心、员工消息收件箱
